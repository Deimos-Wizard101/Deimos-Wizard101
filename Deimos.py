...
from src.config_combat import StrCombatConfigProvider, default_config, delegate_combat_configs
...
def run_updater():
    download_file(
        url=f"{repo_path_raw}/{tool_name}Updater.exe", file_name=f"{tool_name}Updater.exe", delete_previous=True
    )
    time.sleep(0.1)
...
async def xyz_sync(
    foreground_client: Client, background_clients: list[Client], turn_after: bool = True, debug: bool = False
):
...
async def main():
    ...
    async def toggle_speed_hotkey():
        ...
        if not freecam_status:
            if speed_task is not None and not speed_task.cancelled():
                ...
                gui_send_queue.put(
                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("SpeedhackStatus", "Disabled"))
                )
                ...
                gui_send_queue.put(
                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("SpeedhackStatus", "Enabled"))
                )
    ...
    async def toggle_combat_hotkey(debug: bool = True):
        ...
        if not freecam_status:
            if combat_task is not None and not combat_task.cancelled():
                ...
                gui_send_queue.put(
                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("CombatStatus", "Disabled"))
                )
                ...
                gui_send_queue.put(
                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("CombatStatus", "Enabled"))
                )
    ...
    async def toggle_dialogue_hotkey():
        ...
        if not freecam_status:
            if dialogue_task is not None and not dialogue_task.cancelled():
                ...
                gui_send_queue.put(
                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("DialogueStatus", "Disabled"))
                )
                ...
                gui_send_queue.put(
                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("DialogueStatus", "Enabled"))
                )
    ...
    async def toggle_sigil_hotkey():
        ...
        if not freecam_status:
            ...
            if sigil_task is not None and not sigil_task.cancelled():
                ...
                gui_send_queue.put(
                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("SigilStatus", "Disabled"))
                )
                ...
                if questing_task is not None and not questing_task.cancelled():
                    ...
                    gui_send_queue.put(
                        deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("QuestingStatus", "Disabled"))
                    )
                ...
                gui_send_queue.put(
                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("SigilStatus", "Enabled"))
                )
        ...
        if foreground_client:
            if await is_free(foreground_client):
                if await foreground_client.game_client.is_freecam():
                    ...
                    freecam_status = False
                    gui_send_queue.put(
                        deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("FreecamStatus", "Disabled"))
                    )
                    ...
                    gui_send_queue.put(
                        deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("FreecamStatus", "Enabled"))
                    )
    ...
    async def toggle_questing_hotkey():
        ...
        if not freecam_status:
            ...
            if questing_task is not None and not questing_task.cancelled():
                ...
                gui_send_queue.put(
                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("QuestingStatus", "Enabled"))
                )
    ...
    async def toggle_auto_pet_hotkey():
        ...
        if not freecam_status:
            ...
            if auto_pet_task is not None and not auto_pet_task.cancelled():
                ...
                gui_send_queue.put(
                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("Auto PetStatus", "Disabled"))
                )
                ...
                gui_send_queue.put(
                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("Auto PetStatus", "Enabled"))
                )
    ...
    async def toggle_auto_potion_hotkey():
        ...
        if not freecam_status:
            ...
            if auto_potion_status:
                ...
                gui_send_queue.put(
                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("Auto PotionStatus", "Enabled"))
                )

            else:
                logger.debug(f"Disabling auto potion.")
                gui_send_queue.put(
                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("Auto PotionStatus", "Disabled"))
                )
        ...
        async def async_auto_pet(client: Client):
            while True:
                ...
                if client in walker.clients and auto_pet_status:
                    await nomnom(
                        client, ignore_pet_level_up=ignore_pet_level_up, only_play_dance_game=only_play_dance_game
                    )
                            ...
                            # extra leeway on this allows clients to teleport more quickly to ensure that they arrive before the selection phase even starts
                                ...
                                if p.duel_circle_joinable and not p.in_solo_zone:
                                    ...
                                    for c in other_clients:
                                        ...
                                        if (
                                            client_is_hitter_client and all_already_in_battle and none_in_solo_zone
    ...
    def _send_hooked_clients_update():
        gui_send_queue.put(
            deimosgui.GUICommand(deimosgui.GUICommandType.UpdateHookedClients, _build_hooked_clients_info())
        )
                    ...
                    try:
                        ...
                        if cam is not None:
                            ...
                            if feet is not None and head is not None:
                                ...
                                gui_send_queue.put(
                                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateHighlightBox, None)
                                )

                        else:
                            gui_send_queue.put(deimosgui.GUICommand(deimosgui.GUICommandType.UpdateHighlightBox, None))
            ...
            try:
                while True:
                    try:
                        ...
                        gui_send_queue.put(
                            deimosgui.GUICommand(deimosgui.GUICommandType.UpdateEntityListData, entity_data)
                        )
        ...
        while True:
            if walker.clients and foreground_client:
                try:
                    ...
                    gui_send_queue.put(
                        deimosgui.GUICommand(
                            deimosgui.GUICommandType.UpdateWindow, ("Title", f"Client: {foreground_client.title}")
                        )
                    )
                    gui_send_queue.put(
                        deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("Zone", f"Zone: {current_zone}"))
                    )
                    gui_send_queue.put(
                        deimosgui.GUICommand(
                            deimosgui.GUICommandType.UpdateWindow,
                            ("xyz", f"Position (XYZ): {current_pos.x}, {current_pos.y}, {current_pos.z}"),
                        )
                    )
                    gui_send_queue.put(
                        deimosgui.GUICommand(
                    ...
                    if dead:
                        ...
                        if not walker.clients:
                            gui_send_queue.put(
                                deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("Title", f"Client: None"))
                            )
                            gui_send_queue.put(
                                deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("Zone", f"Zone: "))
                            )
                            gui_send_queue.put(
                                deimosgui.GUICommand(
                                    deimosgui.GUICommandType.UpdateWindow, ("xyz", f"Position (XYZ): ")
                                )
                            )
                            gui_send_queue.put(
                                deimosgui.GUICommand(
                                    deimosgui.GUICommandType.UpdateWindow, ("pry", f"Orientation (PRY): ")
                                )
                            )
                    ...
                    match com.com_type:
                            ...
                            match com.data:
                                ...
                                case GUIKeys.copy_entity_list:
                                    if foreground_client:
                                        ...
                                        gui_send_queue.put(
                                            deimosgui.GUICommand(deimosgui.GUICommandType.ShowEntityListPopup)
                                        )
                                ...
                                case GUIKeys.copy_ui_tree:
                                    if foreground_client:
                                        ...
                                        if ui_tree:
                                            ...
                                            gui_send_queue.put(
                                                deimosgui.GUICommand(
                                                    deimosgui.GUICommandType.ShowUITreePopup, (ui_tree, ui_tree_texts)
                                                )
                                            )
                        ...
                        case deimosgui.GUICommandType.SelectEnemy:
                            if not walker.clients:
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindowValues, ("EnemyInput", [])
                                    )
                                )
                                gui_send_queue.put(
                                    deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindowValues, ("AllyInput", []))
                                )
                                continue
                            ...
                            if foreground_client and await foreground_client.in_battle():
                                ...
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("stat_viewer", stat_lines)
                                    )
                                )
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindowValues, ("EnemyInput", enemy_names)
                                    )
                                )
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindowValues, ("AllyInput", ally_names)
                                    )
                                )
                                ...
                                if enemy_i < len(enemy_names):
                                    gui_send_queue.put(
                                        deimosgui.GUICommand(
                                            deimosgui.GUICommandType.UpdateWindow, ("EnemyInput", enemy_names[enemy_i])
                                        )
                                    )
                                ...
                                if ally_i < len(ally_names):
                                    gui_send_queue.put(
                                        deimosgui.GUICommand(
                                            deimosgui.GUICommandType.UpdateWindow, ("AllyInput", ally_names[ally_i])
                                        )
                                    )
                                ...
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("calc_school", school_name)
                                    )
                                )
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("slot_info", slot_info)
                                    )
                                )
                        ...
                        case deimosgui.GUICommandType.PopulateCamera:
                            ...
                            if foreground_client:
                                ...
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("CamXInput", f"{camera_pos.x:.2f}")
                                    )
                                )
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("CamYInput", f"{camera_pos.y:.2f}")
                                    )
                                )
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("CamZInput", f"{camera_pos.z:.2f}")
                                    )
                                )
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("CamYawInput", f"{camera_yaw:.2f}")
                                    )
                                )
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("CamRollInput", f"{camera_roll:.2f}")
                                    )
                                )
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("CamPitchInput", f"{camera_pitch:.2f}")
                                    )
                                )
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("CamEntityInput", "Player Object")
                                    )
                                )
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                ...
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("CamMinInput", f"{current_min:.2f}")
                                    )
                                )
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("CamMaxInput", f"{current_max:.2f}")
                                    )
                                )
                        ...
                        case deimosgui.GUICommandType.PopulatePlayerGID:
                            ...
                            if foreground_client:
                                ...
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("CamEntityGIDInput", str(gid))
                                    )
                                )
                        ...
                        case deimosgui.GUICommandType.GoToBazaar:
                            ...
                            if foreground_client:
                                ...
                                zoneChanged = await toZone(
                                    clients, "WizardCity/WC_Streets/Interiors/WC_OldeTown_AuctionHouse"
                                )
                        ...
                        case deimosgui.GUICommandType.ExecuteFlythrough:
                            ...
                            async def _flythrough():
                                try:
                                    ...
                                    gui_send_queue.put(
                                        deimosgui.GUICommand(
                                            deimosgui.GUICommandType.UpdateWindow, ("FlythroughStatus", "Disabled")
                                        )
                                    )
                            ...
                            if foreground_client:
                                ...
                                gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("FlythroughStatus", "Enabled")
                                    )
                                )
                        ...
                        case deimosgui.GUICommandType.ExecuteBot:
                            ...
                            bot_task.add_done_callback(
                                lambda _t: gui_send_queue.put(
                                    deimosgui.GUICommand(
                                        deimosgui.GUICommandType.UpdateWindow, ("BotStatus", "Disabled")
                                    )
                                )
                            )
                            gui_send_queue.put(
                                deimosgui.GUICommand(deimosgui.GUICommandType.UpdateWindow, ("BotStatus", "Enabled"))
                            )
                        ...
                        case deimosgui.GUICommandType.LoadAccounts:
                            gui_send_queue.put(
                                deimosgui.GUICommand(
                                    deimosgui.GUICommandType.UpdateAccountList, wizlaunch.list_accounts()
                                )
                            )
            ...
            if walker.clients:
                gui_send_queue.put(
                    deimosgui.GUICommand(
                        deimosgui.GUICommandType.UpdateWindow, ("Auto PetStatus", bool_to_string(auto_pet_status))
                    )
                )
            ...
            if use_potions:
                while True:
                    ...
                    if (
                        ...
                        and not any([freecam_status, client.sigil_status, client.questing_status])
                    ):
    ...
    def ban_thread():
        shake = discsdk.serialize_message(
            discsdk.Opcodes.Handshake, {"v": discsdk.rpc_version, "client_id": str(discsdk.app_id)}
        )
        while True:
            try:
    ...
    async def ban_watcher():
        ...
        try:
            rkey = winreg.CreateKeyEx(
                winreg.HKEY_CURRENT_USER, r"SOFTWARE\Slackaduts\Deimos", access=winreg.KEY_ALL_ACCESS
            )
...
if __name__ == "__main__":
    ...
    current_log = logger.add(
        f"logs/{tool_name} - {generate_timestamp()}.log", encoding="utf-8", enqueue=True, backtrace=True
    )
