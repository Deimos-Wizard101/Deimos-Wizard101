...
class DanceGameMovesHook(SimpleHook):
    ...
    async def bytecode_generator(self, packed_exports):
        return b"\x48\x8b\xd8\x48\x8b\x00\x48\xa3" + packed_exports[0][1] + b"\x48\x8b\xc3\x48\x39\x70\x10"


async def activate_dance_game_moves_hook(self, *, wait_for_ready: bool = False, timeout: float = None):
