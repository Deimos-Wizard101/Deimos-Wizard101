...
from src.teleport_math import are_xyzs_within_threshold, calc_FrontalVector, navmap_tp
                        ...
                        if await get_quest_name(self.client) != self.original_quest:
                            try:
                                ...
                                await asyncio.gather(
                                    *[navmap_tp(p, quest_xyz, leader_client=self.client) for p in self.clients]
                                )
