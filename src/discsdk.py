    ...
    for i in range(10):
        ...
        try:
            handle = win32file.CreateFile(
                path, win32file.GENERIC_READ | win32file.GENERIC_WRITE, 0, None, win32file.OPEN_EXISTING, 0, None
            )
...
shake = serialize_message(Opcodes.Handshake, {"v": rpc_version, "client_id": str(app_id)})
