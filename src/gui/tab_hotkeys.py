...
def build_hotkeys_tab(ctx):
    ...
    _hk_categories = [
        (tl('cat_toggles'), [
            ...
            ("toggle_questing_walk", tl('questing_walk'), toggle_callback(send_queue, GUIKeys.toggle_questing_walk), True, 'QuestingWalk', _toggle_icons['brain']),
            ("toggle_side_questing", tl('side_questing'), toggle_callback(send_queue, GUIKeys.toggle_side_questing), True, 'SideQuesting', _toggle_icons['speech']),
            ("toggle_carry_follow", tl('carry_follow'), toggle_callback(send_queue, GUIKeys.toggle_carry_follow), True, 'CarryFollow', _toggle_icons['users']),
